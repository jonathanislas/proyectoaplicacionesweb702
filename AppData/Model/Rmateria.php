...
class Rmateria{
	...
	public function getAlumns(){
		$sql="SELECT c.calificacion, u.id_usuario, p.nombre, p.ap_p, p.ap_m FROM calificaciones c, persona p, usuario u WHERE p.id_persona=u.id_usuario AND u.id_tipo_usuario= 1 AND p.id_persona=c.id_persona ORDER BY p.ap_p ASC";
